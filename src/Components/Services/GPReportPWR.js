...
function GPReportPWR() {
    ...
    function GetCaseDetailspwr() {
        let url = config.url.local_URL + "GPReport?pwCounterFlag=PR";
    ...
    return (<>
        ...
        <CommonFormHeader heading={"Parawise Remarks submitted Cases List"} />
                    ...
                    casesList?.length > 0 ? (
                        <div style={{ width: "95%" }}>
                            <CommonReactTable data={casesList} columns={columnsList} showFooter={"true"}
                                filename="Parawise Remarks submitted Cases List" />
                        </div>
