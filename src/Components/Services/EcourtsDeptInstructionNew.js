...
function EcourtsDeptInstructionNew() {
    ...
    const formIkEntry = useFormik({
        ...
        onSubmit: (values) => {
            ...
            let url = config.url.local_URL + "CasesListEcourtsDept";
    ...
    const formIk = useFormik({
        ...
        onSubmit: (values) => {
            ...
            const url = config.url.local_URL + "SubmitCategoryecourtsDeptInstruction";
...
export default EcourtsDeptInstructionNew