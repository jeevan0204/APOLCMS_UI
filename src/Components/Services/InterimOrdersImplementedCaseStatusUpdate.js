...
function InterimOrdersImplementedCaseStatusUpdate() {
    ...
    function showGetData() {
        let Url = config.url.local_URL + "InterimOrderImplementation";
        CommonAxiosGet(Url).then((res) => {
            if (res?.data?.status === true) {
                setinterimcasesList(res?.data?.CASESLIST);
            }
            else {
                setinterimcasesList([]);
                seterrmsg(true);
    ...
    function updateStatus(cino) {
        ...
        navigate("/CaseStatusUpdateInterim");
...
export default InterimOrdersImplementedCaseStatusUpdate