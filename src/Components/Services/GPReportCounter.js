...
function GPReportCounter() {
    ...
    function GetCaseDetailspwr() {
        let url = config.url.local_URL + "GPReport?pwCounterFlag=COUNTER";
    ...
    return (<>
        ...
        <CommonFormHeader heading={"Counters filed Cases List"} />
                    ...
                    casesList?.length > 0 ? (
                        <div style={{ width: "95%" }}>
                            <CommonReactTable data={casesList} columns={columnsList} showFooter={"true"}
                                filename="Counters filed Cases List" />
                        </div>
...
export default GPReportCounter