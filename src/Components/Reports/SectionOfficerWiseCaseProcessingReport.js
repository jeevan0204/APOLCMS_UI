...
function SectionOfficerWiseCaseProcessingReport() {
    ...
    function GetProcessingReportList() {
        alert("formIk?.values?.section_code-----" + formIk?.values?.section_code);
        ...
        let url = config.url.local_URL + "SectionOfficerWiseCaseProcessingReport?fromDate=" + FromDate + "&toDate=" + ToDate +
            "&caseTypeId=" + caseTypeId + "&section_code=" + section_code;
        CommonAxiosGet(url).then((res) => {
    ...
    const columns = [
        ...
        {
            Header: 'PWR Uploaded Count', accessor: "pwrcounter_uploaded",
            isClickable: true,
            Cell: ({ row }) => (
                <div style={{ cursor: "pointer", textDecoration: "underline", color: "blue", textAlign: "left", }}
                    onClick={() => {
                        getCasesList(row.original.email, section, 'PWR', 'DATE');
                    }}
                >
        ...
        {
            Header: 'Counter Uploaded Count', accessor: "counter_uploaded",
            isClickable: true,
            Cell: ({ row }) => (
                <div style={{ cursor: "pointer", textDecoration: "underline", color: "blue", textAlign: "left", }}
                    onClick={() => {
        ...
        {
            Header: 'Closed Cases Count', accessor: "closed_cases",
            isClickable: true,
            Cell: ({ row }) => (
                <div style={{ cursor: "pointer", textDecoration: "underline", color: "blue", textAlign: "left", }}
                    onClick={() => {
                        getCasesList(row.original.email, section, 'CLOSE', 'DATE');
                    }}
                >
        ...
        {
            Header: 'Central Tax', accessor: "central",
            isClickable: true,
            Cell: ({ row }) => (
                <div style={{ cursor: "pointer", textDecoration: "underline", color: "blue", textAlign: "left", }}
                    onClick={() => {
                        getCasesList(row.original.email, section, 'CENTRAL', 'DATE');
                    }}
                >
                    {row.original.central}
                </div>
            ),
            Footer: "central"
        },

        {
            ...
            Cell: ({ row }) => (
                <div style={{ cursor: "pointer", textDecoration: "underline", color: "blue", textAlign: "left", }}
                    onClick={() => {
                        getCasesList(row.original.email, section, 'GOI', 'DATE');
                    }}
                >
                    {row.original.goi}
                </div>
...

        {
            ...
            Cell: ({ row }) => (
                <div style={{ cursor: "pointer", textDecoration: "underline", color: "blue", textAlign: "left", }}
                    onClick={() => {
                        getCasesList(row.original.email, section, 'INCOMETAX', 'DATE');
                    }}
                >
    ...
    function getCasesList(email, section, ids, date) {
        let url = config.url.local_URL + "AllCasesDetails?section_code=" + section + "&emailId=" + email + "&ids=" + ids + "&date=" + date;
        CommonAxiosGet(url).then((res) => {
    ...
    return (<>
        ...
        <CommonFormHeader heading="Section Officer Wise Case Processing Report" />
                    ...
                    {reportDetails?.length > 0 ? (
                        <div style={{ width: "98%", marginTop: "5%" }}>
                            <CommonReactTable data={reportDetails} columns={columns} showFooter={"true"}
                                filename="Section Officer Wise Case Processing Report" />
                        </div>
                    ...
                    {section === 'L' && casesList?.length > 0 ? (
                        <div style={{ width: "98%", marginTop: "5%" }}>
                            <CommonReactTable data={casesList} columns={columnlist} showFooter={"true"}
                                filename="Section Officer Wise Case Processing Report Cases List" isBack={true} isBackFunction={isBackFunction} />
                        </div>
...
export default SectionOfficerWiseCaseProcessingReport