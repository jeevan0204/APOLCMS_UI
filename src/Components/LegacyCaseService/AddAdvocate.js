...
function AddAdvocate() {
    ...
    const formIk = useFormik({
        ...
        onSubmit: (values) => {
            const url = config.url.local_URL + "saveAddAdvocatecceDetails";
    ...
    return (<>
        <CommonFormHeader heading={"Add Advocate Cce"} />
                        ...
                        <div className="border px-13 pb-5 mb-6 pt-1">
                            <bst.Row className="px-4 pt-4">
                                <bst.Col xs={12} sm={12} md={12} lg={4} xl={4} xxl={4}>
                                    <label className="mb-0"> Advocate Code <span style={{ color: 'red' }}>*</span></label>
                                    <Field type="text" className="form-control me-1 mt-0" name="advocateCode" />
                                    <ErrorMessage name="advocateCode" component="div" className="text-error" />
                                </bst.Col>
                                <bst.Col xs={12} sm={12} md={12} lg={4} xl={4} xxl={4}>
